### tab0802.r: goodness-of-fit tests comparing variable-variance and
### limited-capacity models with one criterion.  Tests include the Akaike
...
f.tab0802 <- function () {
    ...
    stats <- array(NA, dim=c(length(subjects), 4, length(stimsets)),
                   dimnames=list(subjects,
                     c("aic1", "aic2", "bic1", "bic2"),
                     stimsets))
