### tab0701.r: goodness-of-fit tests comparing fixed- to variable-variance
### unlimited-capacity models.  Tests include the generalized
### likelihood ratio test, Akaike information criterion (AIC), and Bayes
