### data05.r: fits a max-rule model to the data.
###
### Assumptions: unlimited capacity, fixed criterion
###
...
### convert back to data frames
    ...
    data05 <- list(data=data, par=param,
                rsq=with(data,
