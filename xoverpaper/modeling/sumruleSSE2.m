function SSE=sumruleSSE2(params,data)
%
% SSE = sumruleSSE2(params,data)
%
% Determines the sum of squared error for the sumrule model predictions
...
[model_HR,model_FA]=sumrule(S,C,SS,K);
